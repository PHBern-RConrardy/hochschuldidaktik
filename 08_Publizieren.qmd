...
In diesem Kapitel siehst du drei Wege, um deine Quarto-Webseite für Studierende und Kolleginnen und Kollegen zugänglich zu machen. Quarto-Pub ist am einfachsten und in 5 Minuten erledigt, die Daten landen bei der Non-Profit Organisation hinter Quarto. Eine Speicherbegrenzung ist nicht bekannt, aber es wäre schön deren Wohlwollen nicht zu missbrauchen und auch privat etwas zu spenden.  Github Pages ist von Microsoft und primär für Programmierer gedacht, es bietet also mehr Möglichkeiten und Komplexität. Auch das Einbinden in Ilias als HTML funktioniert, aber bei jeder Änderung muss die Webseite manuell neu hochgeladen werden.
